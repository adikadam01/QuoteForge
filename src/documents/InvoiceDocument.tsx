...
const styles = StyleSheet.create({
  ...
  // ---------- Body wrapper (all content below accent bar) ----------
  body: {
    paddingHorizontal: 48,
    paddingTop: 32,
  },
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.body}>
          ...
          {/* Notes */}
          {invoice.notes ? (
            <View style={[styles.notesSection, { borderLeftColor: primaryColor }]}>
              <Text style={styles.notesLabel}>Payment Info / Notes</Text>
              <Text style={styles.notesText}>{invoice.notes}</Text>
            </View>
          ) : null}
